...
* [Tokscale](https://github.com/junhoyeo/tokscale) ⭐ 5,467 | 🐛 67 | 🌐 Rust | 📅 2026-09-15 - CLI tool for tracking token usage from AmpCode and other coding agents.
* [Sandboxed.sh](https://github.com/Th0rgal/sandboxed.sh) ⭐ 512 | 🐛 17 | 🌐 Rust | 📅 2026-09-17 - Self-hosted cloud orchestrator for AI coding agents with isolated Linux environments.
...
* [Amp ACP](https://github.com/tao12345666333/amp-acp) ⭐ 91 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-17 - ACP adapter for Amp Code, enabling Amp to work in the Zed editor.
