...
* [Tokscale](https://github.com/junhoyeo/tokscale) ⭐ 5,457 | 🐛 66 | 🌐 Rust | 📅 2026-09-15 - CLI tool for tracking token usage from AmpCode and other coding agents.
* [Sandboxed.sh](https://github.com/Th0rgal/sandboxed.sh) ⭐ 511 | 🐛 16 | 🌐 Rust | 📅 2026-09-15 - Self-hosted cloud orchestrator for AI coding agents with isolated Linux environments.
...
* [Amp ACP](https://github.com/tao12345666333/amp-acp) ⭐ 90 | 🐛 4 | 🌐 TypeScript | 📅 2026-09-14 - ACP adapter for Amp Code, enabling Amp to work in the Zed editor.
