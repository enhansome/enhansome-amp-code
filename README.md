...
* [CleanShot MCP](https://github.com/jdorfman/cleanshot-mcp) ⭐ 13 | 🐛 0 | 🌐 JavaScript | 📅 2025-07-06 - MCP server for CleanShot X screenshot and recording integration.
...
* [Tokscale](https://github.com/junhoyeo/tokscale) ⭐ 5,431 | 🐛 68 | 🌐 Rust | 📅 2026-09-14 - CLI tool for tracking token usage from AmpCode and other coding agents.
* [Sandboxed.sh](https://github.com/Th0rgal/sandboxed.sh) ⭐ 510 | 🐛 16 | 🌐 Rust | 📅 2026-09-10 - Self-hosted cloud orchestrator for AI coding agents with isolated Linux environments.
...
* [Amp ACP](https://github.com/tao12345666333/amp-acp) ⭐ 90 | 🐛 3 | 🌐 TypeScript | 📅 2026-09-14 - ACP adapter for Amp Code, enabling Amp to work in the Zed editor.
