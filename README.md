...
* [Tokscale](https://github.com/junhoyeo/tokscale) ⭐ 5,150 | 🐛 62 | 🌐 Rust | 📅 2026-08-24 - CLI tool for tracking token usage from AmpCode and other coding agents.
...
* [Amp ACP](https://github.com/tao12345666333/amp-acp) ⭐ 86 | 🐛 9 | 🌐 TypeScript | 📅 2026-07-31 - ACP adapter for Amp Code, enabling Amp to work in the Zed editor.
