...
* [Ultimate MCP Client](https://github.com/Dicklesworthstone/ultimate_mcp_client/blob/main/AGENT.md) ⭐ 150 | 🐛 0 | 🌐 Python | 📅 2026-09-21 - Comprehensive MCP client implementation.
...
* [Ultimate MCP Client](https://github.com/Dicklesworthstone/ultimate_mcp_client) ⭐ 150 | 🐛 0 | 🌐 Python | 📅 2026-09-21 - Comprehensive MCP client for testing and debugging servers.
...
* [Tokscale](https://github.com/junhoyeo/tokscale) ⭐ 5,504 | 🐛 68 | 🌐 Rust | 📅 2026-09-21 - CLI tool for tracking token usage from AmpCode and other coding agents.
* [Sandboxed.sh](https://github.com/Th0rgal/sandboxed.sh) ⭐ 513 | 🐛 16 | 🌐 Rust | 📅 2026-09-21 - Self-hosted cloud orchestrator for AI coding agents with isolated Linux environments.
