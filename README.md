...
* [Tokscale](https://github.com/junhoyeo/tokscale) ⭐ 5,010 | 🐛 63 | 🌐 Rust | 📅 2026-08-17 - CLI tool for tracking token usage from AmpCode and other coding agents.
* [Sandboxed.sh](https://github.com/Th0rgal/sandboxed.sh) ⭐ 484 | 🐛 15 | 🌐 Rust | 📅 2026-08-17 - Self-hosted cloud orchestrator for AI coding agents with isolated Linux environments.
